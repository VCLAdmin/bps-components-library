    ...
    ***************************************************************************** */
    ...
    var BpsButtonComponent = /** @class */ (function () {
        function BpsButtonComponent(elementRef, cdr, renderer, contentObserver, nzUpdateHostClassService, ngZone, nzConfigService, waveConfig, animationType) {
            ...
            this.isSelectedChange = new core.EventEmitter();
    ...
    var BpsTooltipDirective = /** @class */ (function (_super) {
        ...
        __decorate([
            core.Input('bpsTooltipDisabled'), core$1.InputBoolean()
    ...
    var BpsListItemComponent = /** @class */ (function () {
        function BpsListItemComponent(elementRef, renderer, parentComp, cdr) {
            ...
            this.ondeletehover = new core.EventEmitter();
    ...
    var BpsTableComponent = /** @class */ (function () {
        function BpsTableComponent(cdr, i18n) {
            ...
            this.ondblclickRow = new core.EventEmitter();
    ...
    var BpsTreeComponent = /** @class */ (function (_super) {
        ...
        function BpsTreeComponent(nzTreeService, nzConfigService, cdr, noAnimation) {
            ...
            _this.bpsExpandedKeysChange = new core.EventEmitter();
            _this.bpsSelectedKeysChange = new core.EventEmitter();
            _this.bpsCheckedKeysChange = new core.EventEmitter();
            _this.bpsSearchValueChange = new core.EventEmitter();
            /**
             * @deprecated use `nzSearchValueChange` instead.
             */
            _this.bpsOnSearchNode = new core.EventEmitter();
            _this.bpsClick = new core.EventEmitter();
            _this.bpsDblClick = new core.EventEmitter();
            _this.bpsContextMenu = new core.EventEmitter();
            _this.bpsCheckBoxChange = new core.EventEmitter();
            _this.bpsExpandChange = new core.EventEmitter();
            _this.bpsOnDragStart = new core.EventEmitter();
            _this.bpsOnDragEnter = new core.EventEmitter();
            _this.bpsOnDragOver = new core.EventEmitter();
            _this.bpsOnDragLeave = new core.EventEmitter();
            _this.bpsOnDrop = new core.EventEmitter();
            _this.bpsOnDragEnd = new core.EventEmitter();
            _this.bpsDefaultSubject = new rxjs.ReplaySubject(6);
        ...
        Object.defineProperty(BpsTreeComponent.prototype, "bpsDefaultExpandAll", {
             ...
             */
            set: function (value) {
                core$1.warnDeprecation("'bpsDefaultExpandAll' would be removed in 9.0.0. Please use 'bpsExpandAll' instead.");
        ...
        Object.defineProperty(BpsTreeComponent.prototype, "bpsDefaultExpandedKeys", {
             ...
             */
            set: function (value) {
                core$1.warnDeprecation("'bpsDefaultExpandedKeys' would be removed in 9.0.0. Please use 'bpsExpandedKeys' instead.");
        ...
        Object.defineProperty(BpsTreeComponent.prototype, "bpsDefaultSelectedKeys", {
             ...
             */
            set: function (value) {
                core$1.warnDeprecation("'bpsDefaultSelectedKeys' would be removed in 9.0.0. Please use 'bpsSelectedKeys' instead.");
        ...
        Object.defineProperty(BpsTreeComponent.prototype, "bpsDefaultCheckedKeys", {
             ...
             */
            set: function (value) {
                core$1.warnDeprecation("'bpsDefaultCheckedKeys' would be removed in 9.0.0. Please use 'bpsCheckedKeys' instead.");
        ...
        BpsTreeComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.setClassMap();
            this.bpsDefaultSubject.pipe(operators.takeUntil(this.destroy$)).subscribe(function (data) {
                if (!data || !data.keys) {
                    return;
                }
                switch (data.type) {
        ...
        __decorate([
            core.Input(), core$1.InputBoolean(), core$1.WithConfig(NZ_CONFIG_COMPONENT_NAME$5, false)
        ...
        __decorate([
            core.Input(), core$1.WithConfig(NZ_CONFIG_COMPONENT_NAME$5, false), core$1.InputBoolean()
        ...
        __decorate([
            core.ContentChild('bpsTreeTemplate', { static: true })
        ...
        BpsTreeComponent = BpsTreeComponent_1 = __decorate([
            core.Component({
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                providers: [
                    ngZorroAntd.NzTreeService,
                    {
                        provide: core$1.NzTreeBaseService,
                        useFactory: NzTreeServiceFactory,
                        deps: [[new core.SkipSelf(), new core.Optional(), core$1.NzTreeHigherOrderServiceToken], ngZorroAntd.NzTreeService]
                    },
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return BpsTreeComponent_1; }),
                        multi: true
                    }
                ],
    ...
    var BpsTreeNodeComponent = /** @class */ (function () {
        ...
        Object.defineProperty(BpsTreeNodeComponent.prototype, "bpsDefaultExpandAll", {
             ...
             */
            set: function (value) {
                core$1.warnDeprecation("'bpsDefaultExpandAll' is going to be removed in 9.0.0. Please use 'bpsExpandAll' instead.");
        ...
        BpsTreeNodeComponent.prototype.ngOnInit = function () {
            ...
            this.nzTreeService
                .eventTriggerChanged()
                .pipe(operators.filter(function (data) { return data.node.key === _this.bpsTreeNode.key; }), operators.takeUntil(this.destroy$))
                .subscribe(function () {
                _this.setClassMap();
                _this.markForCheck();
            });
        ...
        __decorate([
            core.ViewChild('dragElement', { static: false })
    ...
    var BpsModalFooterDirective = /** @class */ (function () {
        ...
        BpsModalFooterDirective.ctorParameters = function () { return [
            { type: ngZorroAntd.NzModalRef, decorators: [{ type: core.Optional }] },
    ...
    var BpsModalControlService = /** @class */ (function () {
        ...
        BpsModalControlService.ctorParameters = function () { return [
            { type: BpsModalControlService, decorators: [{ type: core.Optional }, { type: core.SkipSelf }] }
        ]; };
        BpsModalControlService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function BpsModalControlService_Factory() { return new BpsModalControlService(core["ɵɵinject"](BpsModalControlService, 12)); }, token: BpsModalControlService, providedIn: modal.NzModalControlServiceModule });
        BpsModalControlService = __decorate([
            core.Injectable({
                providedIn: ngZorroAntd.NzModalControlServiceModule
            }),
    ...
    var BpsModalComponent = /** @class */ (function (_super) {
        ...
        function BpsModalComponent(nzConfigService, overlay, overlayKeyboardDispatcher, i18n, cfr, elementRef, viewContainer, modalControl, focusTrapFactory, cdr, bpsModalGlobalConfig, document // tslint:disable-line:no-any
            ...
            _this.bpsOnOk = new core.EventEmitter();
            _this.bpsOnCancel = new core.EventEmitter();
            _this.bpsAfterOpen = new core.EventEmitter(); // Trigger when modal open(visible) after animations
            _this.bpsAfterClose = new core.EventEmitter(); // Trigger when modal leave-animation over
            _this.bpsVisibleChange = new core.EventEmitter();
            _this.locale = {};
        ...
        BpsModalComponent.prototype.keydownListener = function (event) {
            if (event.keyCode === keycodes.ESCAPE && this.bpsKeyboard) {
        ...
        __decorate([
            core.Input(), core$1.WithConfig(NZ_CONFIG_COMPONENT_NAME$6), core$1.InputBoolean()
        ...
        __decorate([
            core.ViewChild('modalContainer', { static: true })
        ], BpsModalComponent.prototype, "modalContainer", void 0);
        __decorate([
            core.ViewChild('bodyContainer', { static: false, read: core.ViewContainerRef })
        ], BpsModalComponent.prototype, "bodyContainer", void 0);
        __decorate([
            core.ViewChild('autoFocusButtonOk', { static: false, read: core.ElementRef })
        ], BpsModalComponent.prototype, "autoFocusButtonOk", void 0);
        __decorate([
            core.ContentChild(BpsModalFooterDirective, { static: false })
        ...
        BpsModalComponent = __decorate([
            ...
            // tslint:disable-next-line:no-any
            ,
            __param(10, core.Optional()), __param(10, core.Inject(NZ_MODAL_CONFIG)),
            __param(11, core.Inject(common.DOCUMENT))
        ], BpsModalComponent);
    ...
    exports.BpsModalComponent = BpsModalComponent;
    exports.BpsModalFooterDirective = BpsModalFooterDirective;
    ...
    exports.ɵ0 = ɵ0;
    exports.ɵa = BpsModalRef;
    exports.ɵc = NZ_MODAL_CONFIG;
    exports.ɵd = BpsModalControlService;
    exports.ɵe = NzTooltipBaseDirective;
