...
export declare class BpsDropDownDirective implements AfterViewInit, OnDestroy, OnChanges {
    ...
    private overlay;
    private platform;
    private bpsButtonComponent;
    private bpsButtonGroupComponent;
    ...
    bpsDropdownMenu: BpsDropdownMenuComponent;
    bpsTrigger: 'click' | 'hover';
    bpsMatchWidthElement: ElementRef;
    bpsBackdrop: boolean;
    ...
    constructor(elementRef: ElementRef, renderer: Renderer2, overlay: Overlay, platform: Platform, bpsButtonComponent: BpsButtonComponent, bpsButtonGroupComponent: BpsButtonGroupComponent, viewContainerRef: ViewContainerRef);
